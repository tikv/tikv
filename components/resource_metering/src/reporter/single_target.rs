...
pub fn init_single_target(
    ...
    let mut single_target_worker = WorkerBuilder::new(RESOURCE_METERING_SINGLE_TARGET_DATA_SINK_THREAD_PREFIX)
        .pending_capacity(10)
        .create()
        .lazy_build(RESOURCE_METERING_SINGLE_TARGET_DATA_SINK_THREAD_PREFIX);
