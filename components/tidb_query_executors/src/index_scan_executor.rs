    ...
    fn test_int_handle_char_index() {
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x8, 0x7d, 0x80, 0x0, 0x1, 0x0, 0x0, 0x0, 0x3, 0x1, 0x0, 0x41, 0x0, 0x0, 0x0,
                    0x0, 0x0, 0x0, 0x0, 0x1,
                ],
                &mut columns,
            )
    ...
    fn test_int_handle_varchar_index() {
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x8, 0x7d, 0x80, 0x0, 0x1, 0x0, 0x0, 0x0, 0x2, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0,
                    0x0, 0x0, 0x0, 0x0, 0x1,
                ],
                &mut columns,
            )
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x8, 0x7d, 0x80, 0x0, 0x1, 0x0, 0x0, 0x0, 0x3, 0x2, 0x0, 0x41, 0x20, 0x0, 0x0,
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x0, 0x7d, 0x80, 0x0, 0x2, 0x0, 0x0, 0x0, 0x2, 0x3, 0x1, 0x0, 0x3, 0x0, 0x1,
                    0x41, 0x20,
                ],
                &mut columns,
            )
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x8, 0x7d, 0x80, 0x0, 0x2, 0x0, 0x0, 0x0, 0x2, 0x3, 0x1, 0x0, 0x3, 0x0, 0x1,
                    0x41, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1,
                ],
                &mut columns,
            )
            .unwrap();
    ...
    fn test_common_handle_index() {
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x0, 0x7d, 0x80, 0x0, 0x3, 0x0, 0x0, 0x0, 0x3, 0x4, 0x5, 0x1, 0x0, 0x2, 0x0,
                    0x4, 0x0, 0x41, 0x1, 0x41, 0x20,
                ],
                &mut columns,
            )
            .unwrap();
        ...
        idx_exe
            .process_kv_pair(
                ...
                &[
                    0x0, 0x7f, 0x0, 0x31, 0x3, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x61,
                    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf8, 0x1, 0xe, 0x33, 0x0, 0x0, 0x0, 0x0,
                    0x0, 0x0, 0xf9, 0x1, 0x61, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf8, 0x1, 0x0,
                    0x41, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf9, 0x7d, 0x80, 0x0, 0x3, 0x0, 0x0, 0x0,
                    0x3, 0x4, 0x5, 0x1, 0x0, 0x2, 0x0, 0x4, 0x0, 0x41, 0x1, 0x41, 0x20,
                ],
                &mut columns,
            )
            .unwrap();
