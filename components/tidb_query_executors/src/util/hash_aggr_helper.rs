...
impl HashAggregationHelper {
    ...
    ///
    /// Each row may belong to a different group. States of all groups should be passed in
    /// altogether in a single vector and the states of each row should be specified by an
    /// offset vector.
