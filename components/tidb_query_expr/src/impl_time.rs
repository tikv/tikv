...
mod tests {
    ...
    fn test_add_date_and_duration() {
        ...
        for (arg0, arg1, exp) in cases {
            ...
            let arg0 =
                arg0.map(|arg0| Time::parse_datetime(&mut ctx, arg0, MAX_FSP, true).unwrap());
            let arg1 = arg1.map(|arg1| Duration::parse(&mut ctx, arg1, MAX_FSP).unwrap());

            let output = RpnFnScalarEvaluator::new()
                .push_param(arg0)
                .push_param(arg1)
                .evaluate(ScalarFuncSig::AddDateAndDuration);
    ...
    fn test_sub_date_and_string() {
        ...
        let cases = vec![
            ...
            (Some("2021-03-26"), Some("24:00:01"), Some("2021-03-24")),
            (
                Some("2021-03-26 00:00:30"),
                Some("-00:01:00"),
                Some("2021-03-26"),
            ),
            (Some("2019-01-02"), Some("1 01:30:30"), Some("2018-12-31")),
            (
                Some("2021-03-26"),
                Some("00:00:00.123456"),
                Some("2021-03-25"),
    ...
    fn test_sub_date_and_duration() {
        ...
        for (arg0, arg1, exp) in cases {
            ...
            let output = RpnFnScalarEvaluator::new()
                .push_param(arg0)
                .push_param(arg1)
                .evaluate(ScalarFuncSig::SubDateAndDuration);
            let output = output.unwrap();
            assert_eq!(output, exp);
        }
    }
