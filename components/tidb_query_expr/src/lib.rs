...
fn map_expr_node_to_rpn_func(expr: &Expr) -> Result<RpnFnMeta> {
    ...
    Ok(match value {
        ...
        ScalarFuncSig::AddDateStringString => add_date_time_string_interval_string_as_bytes_fn_meta(),
        ScalarFuncSig::SubDateStringString => sub_date_time_string_interval_string_as_bytes_fn_meta(),
        ScalarFuncSig::AddDateStringInt => add_date_time_string_as_bytes_fn_meta::<i64>(),
        ScalarFuncSig::SubDateStringInt => sub_date_time_string_as_bytes_fn_meta::<i64>(),
        ScalarFuncSig::AddDateStringReal => add_date_time_string_as_bytes_fn_meta::<Real>(),
        ScalarFuncSig::SubDateStringReal => sub_date_time_string_as_bytes_fn_meta::<Real>(),
        ScalarFuncSig::AddDateStringDecimal => add_date_time_string_as_bytes_fn_meta::<Decimal>(),
        ScalarFuncSig::SubDateStringDecimal => sub_date_time_string_as_bytes_fn_meta::<Decimal>(),
        ScalarFuncSig::AddDateIntString => add_date_interval_string_as_bytes_fn_meta::<i64>(),
        ScalarFuncSig::SubDateIntString => sub_date_interval_string_as_bytes_fn_meta::<i64>(),
        ScalarFuncSig::AddDateRealString => add_date_interval_string_as_bytes_fn_meta::<Real>(),
        ScalarFuncSig::SubDateRealString => sub_date_interval_string_as_bytes_fn_meta::<Real>(),
        ScalarFuncSig::AddDateDecimalString => add_date_interval_string_as_bytes_fn_meta::<Decimal>(),
        ScalarFuncSig::SubDateDecimalString => sub_date_interval_string_as_bytes_fn_meta::<Decimal>(),
        ScalarFuncSig::AddDateIntInt => add_date_as_bytes_fn_meta::<i64, i64>(),
        ScalarFuncSig::SubDateIntInt => add_date_as_bytes_fn_meta::<i64, i64>(),
        ScalarFuncSig::AddDateIntReal => add_date_as_bytes_fn_meta::<i64, Real>(),
        ScalarFuncSig::SubDateIntReal => add_date_as_bytes_fn_meta::<i64, Real>(),
        ScalarFuncSig::AddDateIntDecimal => add_date_as_bytes_fn_meta::<i64, Decimal>(),
        ScalarFuncSig::SubDateIntDecimal => add_date_as_bytes_fn_meta::<i64, Decimal>(),
        ScalarFuncSig::AddDateRealInt => add_date_as_bytes_fn_meta::<Real, i64>(),
        ScalarFuncSig::SubDateRealInt => add_date_as_bytes_fn_meta::<Real, i64>(),
        ScalarFuncSig::AddDateRealReal => add_date_as_bytes_fn_meta::<Real, Real>(),
        ScalarFuncSig::SubDateRealReal => add_date_as_bytes_fn_meta::<Real, Real>(),
        ScalarFuncSig::AddDateRealDecimal => add_date_as_bytes_fn_meta::<Real, Decimal>(),
        ScalarFuncSig::SubDateRealDecimal => add_date_as_bytes_fn_meta::<Real, Decimal>(),
        ScalarFuncSig::AddDateDecimalInt => add_date_as_bytes_fn_meta::<Decimal, i64>(),
        ScalarFuncSig::SubDateDecimalInt => add_date_as_bytes_fn_meta::<Decimal, i64>(),
        ScalarFuncSig::AddDateDecimalReal => add_date_as_bytes_fn_meta::<Decimal, Real>(),
        ScalarFuncSig::SubDateDecimalReal => add_date_as_bytes_fn_meta::<Decimal, Real>(),
        ScalarFuncSig::AddDateDecimalDecimal => add_date_as_bytes_fn_meta::<Decimal, Decimal>(),
        ScalarFuncSig::SubDateDecimalDecimal => add_date_as_bytes_fn_meta::<Decimal, Decimal>(),
