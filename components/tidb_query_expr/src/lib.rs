...
fn map_expr_node_to_rpn_func(expr: &Expr) -> Result<RpnFnMeta> {
    ...
    Ok(match value {
        ...
        ScalarFuncSig::SubDateIntInt => sub_date_as_bytes_fn_meta::<i64, i64>(),
        ScalarFuncSig::AddDateIntReal => add_date_as_bytes_fn_meta::<i64, Real>(),
        ScalarFuncSig::SubDateIntReal => sub_date_as_bytes_fn_meta::<i64, Real>(),
        ScalarFuncSig::AddDateIntDecimal => add_date_as_bytes_fn_meta::<i64, Decimal>(),
        ScalarFuncSig::SubDateIntDecimal => sub_date_as_bytes_fn_meta::<i64, Decimal>(),
        ScalarFuncSig::AddDateRealInt => add_date_as_bytes_fn_meta::<Real, i64>(),
        ScalarFuncSig::SubDateRealInt => sub_date_as_bytes_fn_meta::<Real, i64>(),
        ScalarFuncSig::AddDateRealReal => add_date_as_bytes_fn_meta::<Real, Real>(),
        ScalarFuncSig::SubDateRealReal => sub_date_as_bytes_fn_meta::<Real, Real>(),
        ScalarFuncSig::AddDateRealDecimal => add_date_as_bytes_fn_meta::<Real, Decimal>(),
        ScalarFuncSig::SubDateRealDecimal => sub_date_as_bytes_fn_meta::<Real, Decimal>(),
        ScalarFuncSig::AddDateDecimalInt => add_date_as_bytes_fn_meta::<Decimal, i64>(),
        ScalarFuncSig::SubDateDecimalInt => sub_date_as_bytes_fn_meta::<Decimal, i64>(),
        ScalarFuncSig::AddDateDecimalReal => add_date_as_bytes_fn_meta::<Decimal, Real>(),
        ScalarFuncSig::SubDateDecimalReal => sub_date_as_bytes_fn_meta::<Decimal, Real>(),
        ScalarFuncSig::AddDateDecimalDecimal => add_date_as_bytes_fn_meta::<Decimal, Decimal>(),
        ScalarFuncSig::SubDateDecimalDecimal => sub_date_as_bytes_fn_meta::<Decimal, Decimal>(),
