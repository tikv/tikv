...
mod tests {
    ...
    fn test_parse_valid_datetime() -> Result<()> {
        ...
        let cases = vec![
            ...
            ("2022-06-02 03:59:30", "2022-06-02 11:59:30.123+0800", 0, false),
            ("2022-06-02 19:59:30", "2022-06-02 11:59:30.123-08", 0, false),
            ("2022-06-02 03:29:30", "2022-06-02 11:59:30.123+08:30", 0, false),
        ];
