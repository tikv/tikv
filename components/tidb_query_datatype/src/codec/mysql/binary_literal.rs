...
impl BinaryLiteral {
    ...
    /// byte size will be used as the length of the new BinaryLiteral, with leading bytes filled to
    /// zero. If byte size is -1, the leading zeros in new BinaryLiteral will be trimmed.
