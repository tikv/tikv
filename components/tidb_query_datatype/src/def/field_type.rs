...
impl Collation {
    ...
    pub fn from_i32(n: i32) -> Result<Self, DataTypeError> {
        match n {
            ...
            -8 => Ok(Collation::Latin1SwedishCi),
...
mod tests {
    ...
    fn test_collate_from_i32() {
        let cases = vec![
            ...
            (-8, Some(Collation::Latin1SwedishCi)),
    ...
    fn test_need_restored_data() {
        let cases = vec![
            ...
            (FieldTypeTp::String, Collation::Latin1SwedishCi, true),
            (FieldTypeTp::VarString, Collation::Latin1SwedishCi, true),
