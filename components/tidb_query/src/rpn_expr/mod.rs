...
fn map_expr_node_to_rpn_func(expr: &Expr) -> Result<RpnFnMeta> {
    ...
    Ok(match value {
        ...
        ScalarFuncSig::RoundInt => round_fn_meta::<RoundInt>(),
        ScalarFuncSig::RoundReal => round_fn_meta::<RoundReal>(),
        ScalarFuncSig::RoundDec => round_fn_meta::<RoundDec>(),
        ScalarFuncSig::RoundWithFracInt => round_with_frac_fn_meta::<RoundWithFracInt>(),
        ScalarFuncSig::RoundWithFracReal => round_with_frac_fn_meta::<RoundWithFracReal>(),
        ScalarFuncSig::RoundWithFracDec => round_with_frac_fn_meta::<RoundWithFracDec>(),
