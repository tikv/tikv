...
mod tests {
    ...
    fn test_cast_as_int() {
        ...
        let cases = vec![
            ...
            (
                ...
                FieldTypeTp::JSON,
                None,
                vec![Datum::Json(Json::from_i64(-1))],
                -1,
            ),
            (
                ScalarFuncSig::CastJsonAsInt,
                FieldTypeTp::JSON,
                None,
                vec![Datum::Json(Json::from_u64(1))],
                1,
            ),
            (
    ...
    fn test_cast_as_str() {
        ...
        let cases = vec![
            ...
            (
                ...
                charset::CHARSET_UTF8,
                None,
                vec![Datum::Json(Json::from_i64(1234))],
                2,
                b"12".to_vec(),
            ),
            (
    ...
    fn test_cast_as_time() {
        ...
        let json_cols = vec![Datum::Json(Json::from_string(t_time_str.clone()))];
    ...
    fn test_cast_as_duration() {
        ...
        let json_cols = vec![Datum::Json(Json::from_string(String::from(dur_str)))];
    ...
    fn test_cast_int_as_json() {
        ...
        let cases = vec![
            (
                Some(FieldTypeFlag::UNSIGNED),
                vec![Datum::U64(32)],
                Some(Json::from_u64(32)),
            ),
            (
                Some(FieldTypeFlag::UNSIGNED | FieldTypeFlag::IS_BOOLEAN),
                vec![Datum::U64(1)],
                Some(Json::from_bool(true)),
            ),
            (
                Some(FieldTypeFlag::UNSIGNED | FieldTypeFlag::IS_BOOLEAN),
                vec![Datum::I64(0)],
                Some(Json::from_bool(false)),
            ),
            (None, vec![Datum::I64(-1)], Some(Json::from_i64(-1))),
    ...
    fn test_cast_real_as_json() {
        let mut ctx = EvalContext::new(Arc::new(EvalConfig::default_for_test()));
        let cases = vec![
            (vec![Datum::F64(32.0001)], Some(Json::from_f64(32.0001))),
            (vec![Datum::Null], None),
        ];
    ...
    fn test_cast_str_as_json() {
        ...
        let cases = vec![
            (
                ...
                Some(Json::from_string(String::from("[1,2,3]"))),
            ),
            (
                true,
                vec![Datum::Bytes(b"[1,2,3]".to_vec())],
                Some(Json::from_array(vec![
                    Json::from_i64(1),
                    Json::from_i64(2),
                    Json::from_i64(3),
                ])),
    ...
    fn test_cast_time_as_json() {
        ...
        let cases = vec![
            (
                FieldTypeTp::DateTime,
                vec![Datum::Time(time)],
                Some(Json::from_string(format!("{}.000000", time_str))),
            ),
            (
            ...
            (
                FieldTypeTp::Date,
                vec![Datum::Time(date)],
                Some(Json::from_string(String::from(date_str))),
            ),
    ...
    fn test_cast_duration_as_json() {
        ...
        let cases = vec![
            (
                ...
                Some(Json::from_string(String::from(dur_str_expect))),
            ),
            (vec![Datum::Null], None),
        ];
        for (cols, exp) in cases {
    ...
    fn test_cast_json_as_json() {
        ...
        let cases = vec![
            (
                vec![Datum::Json(Json::from_bool(true))],
                Some(Json::from_bool(true)),
            ),
            (vec![Datum::Null], None),
        ];
