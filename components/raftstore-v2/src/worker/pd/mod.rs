...
use raftstore::store::{
    ...
    PdStatsMonitor, ReadStats, SplitAuditor, SplitInfo, StoreStatsReporter, TabletSnapManager, TxnExt,
    ...
    T: PdClient + 'static,
{
    pub fn new(
        ...
        stats_monitor.start(auto_split_controller, collector_reg_handle, SplitAuditor::new())?;
