...
use tikv_util::{
    ...
    slog_panic,
    thread_name_prefix::{
        TABLET_BACKGROUND_WORKER_THREAD_PREFIX, TABLET_HIGH_PRIORITY_WORKER_THREAD_PREFIX,
    },
    time::Instant,
    ...
    pub fn new(
        ...
        Self {
            ...
            high_pri_pool: YatpPoolBuilder::new(DefaultTicker::default())
                .name_prefix(TABLET_HIGH_PRIORITY_WORKER_THREAD_PREFIX)
            ...
            low_pri_pool: YatpPoolBuilder::new(DefaultTicker::default())
                .name_prefix(TABLET_BACKGROUND_WORKER_THREAD_PREFIX)
