...
lazy_static! {
    ...
    .unwrap();
    pub static ref RANGE_CACHEN_SNAPSHOT_ACQUIRE_FAILED_REASON_COUNT_VEC: IntCounterVec = register_int_counter_vec!(
...
lazy_static! {
    ...
    pub static ref RANGE_CACHEN_SNAPSHOT_ACQUIRE_FAILED_REASON_COUNT_STAIC: FailedReasonCountVec =
        auto_flush_from!(RANGE_CACHEN_SNAPSHOT_ACQUIRE_FAILED_REASON_COUNT_VEC, FailedReasonCountVec);
}
