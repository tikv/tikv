...
use crate::{
    ...
    metrics::{
        CPU_THROTTLE_ALLOCATIONS, CPU_THROTTLE_GLOBAL_BUCKET_AVAILABLE,
        CPU_THROTTLE_GLOBAL_BUCKET_CAPACITY, CPU_THROTTLE_GLOBAL_REFILL_RATE,
        CPU_THROTTLE_GROUP_BUCKET_AVAILABLE, CPU_THROTTLE_GROUP_BUCKET_CAPACITY,
        CPU_THROTTLE_GROUP_REFILL_RATE, CPU_THROTTLE_REFILL_RATE_ADJUSTMENTS,
        ...
        CPU_THROTTLE_UNKNOWN_GROUP, CPU_USAGE_MONITOR_COLLECT_DURATION,
        CPU_USAGE_MONITOR_GLOBAL_RATIO, CPU_USAGE_MONITOR_RESOURCE_GROUP_DAG_RATIO,
        deregister_cpu_throttle_metrics,
    },
};
...
impl ThrottleError {
    pub(crate) fn timeout_allocation_result_label(&self) -> &'static str {
        match self {
            ThrottleError::GlobalCpuExhausted => CPU_THROTTLE_ALLOCATION_GLOBAL_EXHAUSTED,
            ThrottleError::ResourceGroupCpuExhausted => CPU_THROTTLE_ALLOCATION_GROUP_EXHAUSTED,
            ThrottleError::RequestTimeout => CPU_THROTTLE_TOKEN_WAIT_TIMEOUT,
        }
    }
}
...
pub(crate) const CPU_THROTTLE_ALLOCATION_SUCCESS: &str = "success";
pub(crate) const CPU_THROTTLE_ALLOCATION_GLOBAL_EXHAUSTED: &str = "global_exhausted";
pub(crate) const CPU_THROTTLE_ALLOCATION_GROUP_EXHAUSTED: &str = "resource_group_exhausted";
pub(crate) const CPU_THROTTLE_ALLOCATION_BURST: &str = "burst";
pub(crate) const CPU_THROTTLE_ALLOCATION_GLOBAL_ONLY: &str = "global_only";
pub(crate) const CPU_THROTTLE_TOKEN_WAIT_SUCCESS: &str = "success";
pub(crate) const CPU_THROTTLE_TOKEN_WAIT_TIMEOUT: &str = "timeout";
