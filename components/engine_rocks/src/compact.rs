...
impl CompactExt for RocksEngine {
    ...
    fn compact_range_cf(
        ...
        compact_opts.set_exclusive_manual_compaction(compaction_option.exclusive_manual);
        compact_opts.set_max_subcompactions(compaction_option.max_subcompactions as i32);
        if compaction_option.bottommost_level_force {
