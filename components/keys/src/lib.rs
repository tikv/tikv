...
pub const RECOVER_FROM_RAFT_DB_KEY: &[u8] = &[LOCAL_PREFIX, 0x03];
pub const FLUSHED_SEQNO_KEY: &[u8] = &[LOCAL_PREFIX, 0x04];
...
pub const SNAPSHOT_APPLY_STATE_SUFFIX: u8 = 0x06;
pub const SNAPSHOT_REGION_STATE_SUFFIX: u8 = 0x07;
...
pub fn snapshot_apply_state_key(region_id: u64) -> [u8; 11] {
    make_region_prefix(region_id, SNAPSHOT_APPLY_STATE_SUFFIX)
}

pub fn snapshot_region_state_key(region_id: u64) -> [u8; 11] {
    make_region_prefix(region_id, SNAPSHOT_REGION_STATE_SUFFIX)
}
