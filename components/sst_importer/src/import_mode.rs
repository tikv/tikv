...
use tikv_util::{resizable_threadpool::RcRuntimeHandle, timer::GLOBAL_TIMER_HANDLE};
...
impl ImportModeSwitcher {
    ...
    pub fn start_resizable_threads<E: KvEngine>(&self, executor: &RcRuntimeHandle, db: E) {
