...
impl<T: Simulator> Cluster<T> {
    ...
    fn create_engine(&mut self, router: Option<RaftRouter<RocksEngine, RocksEngine, RocksSnapshot>>) {
    ...
    pub fn must_request_snapshot(&self, store_id: u64, region_id: u64) -> u64 {
        ...
        CasualRouter::send(
            &router,
            region_id,
            CasualMessage::AccessPeer(Box::new(move |peer: &mut PeerFsm<RocksEngine, RocksEngine, RocksSnapshot>| {
