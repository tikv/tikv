...
pub trait PdClient: Send + Sync {
    ...
    fn store_heartbeat(&self, _stats: pdpb::StoreStats, _states: Option<vec<pdpb::GroupStates>>, _reports: Option<Vec<pdpb::PeerReport>>) -> PdFuture<pdpb::StoreHeartbeatResponse> {
        unimplemented!();
    }
