            ...
            inner.client_stub.spawn(
                sender
                    ...
                    .send_all(rx.then(move |r| {
                        ...
                        match r {
                            Ok(r) => Ok((r, WriteFlags::default().buffer_hint(last > 1))),
