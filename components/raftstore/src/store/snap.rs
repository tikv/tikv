...
use file_system::{
    ...
    file_exists, get_file_size, sync_dir, File, IoBytes, IoType, Metadata, OpenOptions, WithIoType,
};
...
#[cfg(not(test))]
fn get_thread_io_bytes_stats() -> core::result::Result<file_system::IoBytes, String> {
