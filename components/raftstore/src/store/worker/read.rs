...
pub trait ReadExecutor<E: KvEngine> {
    ...
    fn get_snapshot(
        &mut self,
        read_context: &mut Option<&mut SnapCacheContext<'_, E>>,
    ) -> Arc<E::Snapshot>;
    ...
    fn execute(
        ...
        mut snap_cache_ctx: Option<&mut SnapCacheContext<'_, E>>,
...
pub struct SnapCacheContext<'a, E>
where
    E: KvEngine,
{
