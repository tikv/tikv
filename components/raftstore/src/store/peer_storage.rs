...
pub mod tests {
    ...
    fn test_storage_entries() {
        ...
        for (i, (lo, hi, maxsize, wentries)) in tests.drain(..).enumerate() {
            ...
            let mut raftlog_fetch_worker =
                Worker::new(RAFTLOG_FETCH_WORKER_THREAD_PREFIX).lazy_build(RAFTLOG_FETCH_WORKER_THREAD_PREFIX);
    ...
    fn test_validate_states() {
        ...
        let raftlog_fetch_worker = LazyWorker::new(RAFTLOG_FETCH_WORKER_THREAD_PREFIX);
