...
use crate::store::worker::{
    ...
    CompactRunner, CompactTask, ConsistencyCheckRunner, ConsistencyCheckTask, GcSnapshotRunner,
    GcSnapshotTask, PdRunner, RaftlogGcRunner, RaftlogGcTask, ReadDelegate, RefreshConfigRunner,
...
pub const MULTI_FILES_SNAPSHOT_FEATURE: Feature = Feature::require(6, 0, 0); // it only makes sense for large region
