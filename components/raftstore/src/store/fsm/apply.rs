...
use crate::store::metrics::{self, APPLY_PERF_CONTEXT_TIME_HISTOGRAM_STATIC};
    ...
    ER: KvEngine,
{
    ...
    fn destroy<W: WriteBatch + WriteBatchVecExt<EK>>(&mut self, ctx: &mut ApplyContext<EK, ER, W>) {
