...
impl<EK: KvEngine> ApplyCallback<EK> {
...
pub enum Notifier<E: KvEngines> {
    Router(RaftRouter<E>),
    #[cfg(test)]
    Sender(Sender<PeerMsg<E::Kv>>),
}

impl<E: KvEngines> Clone for Notifier<E> {
    fn clone(&self) -> Self {
        match self {
...
impl<E: KvEngines> Notifier<E> {
    fn notify(&self, region_id: u64, msg: PeerMsg<E::Kv>) {
        match *self {
...
struct ApplyContext<E: KvEngines> {
    tag: String,
    timer: Option<Instant>,
    host: CoprocessorHost<E::Kv>,
    importer: Arc<SSTImporter>,
    region_scheduler: Scheduler<RegionTask<<E::Kv as KvEngine>::Snapshot>>,
    router: ApplyRouter<E::Kv>,
    notifier: Notifier<E>,
    engine: E::Kv,
    cbs: MustConsumeVec<ApplyCallback<E::Kv>>,
    apply_res: Vec<ApplyRes<<E::Kv as KvEngine>::Snapshot>>,
    exec_ctx: Option<ExecContext>,

    kv_wb: Option<<E::Kv as WriteBatchExt>::WriteBatchVec>,
...
impl<E: KvEngines> ApplyContext<E> {
    pub fn new(
        tag: String,
        host: CoprocessorHost<E::Kv>,
        importer: Arc<SSTImporter>,
    ...
    pub fn prepare_for(&mut self, delegate: &mut ApplyDelegate<E::Kv>) {
    ...
    pub fn commit(&mut self, delegate: &mut ApplyDelegate<E::Kv>) {
    ...
    fn commit_opt(&mut self, delegate: &mut ApplyDelegate<E::Kv>, persistent: bool) {
    ...
    pub fn finish_for(
        &mut self,
        delegate: &mut ApplyDelegate<E::Kv>,
        results: VecDeque<ExecResult<<E::Kv as KvEngine>::Snapshot>>,
    ) {
    ...
    #[inline]
    pub fn kv_wb(&self) -> &<E::Kv as WriteBatchExt>::WriteBatchVec {
        self.kv_wb.as_ref().unwrap()
    }

    #[inline]
    pub fn kv_wb_mut(&mut self) -> &mut <E::Kv as WriteBatchExt>::WriteBatchVec {
...
impl<EK: KvEngine> Debug for YieldState<EK> {
...
impl<EK: KvEngine> ApplyDelegate<EK> {
    ...
    fn handle_raft_committed_entries<E: KvEngines<Kv = EK>>(
        &mut self,
    ...
    fn handle_raft_entry_normal<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
        entry: &Entry,
    ...
    fn handle_raft_entry_conf_change<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
        entry: &Entry,
    ) -> ApplyResult<EK::Snapshot> {
    ...
    fn process_raft_cmd<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
        index: u64,
        term: u64,
    ...
    fn apply_raft_cmd<E: KvEngines<Kv = EK>>(
        &mut self,
    ...
    fn destroy<E: KvEngines<Kv = EK>>(&mut self, apply_ctx: &mut ApplyContext<E>) {
        self.stopped = true;
...
impl<EK: KvEngine> ApplyDelegate<EK> {
    ...
    fn exec_raft_cmd<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &RaftCmdRequest,
    ...
    fn exec_admin_cmd<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &RaftCmdRequest,
    ) -> Result<(RaftCmdResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_write_cmd<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &RaftCmdRequest,
    ) -> Result<(RaftCmdResponse, ApplyResult<EK::Snapshot>)> {
...
impl<EK: KvEngine> ApplyDelegate<EK> {
    fn exec_change_peer<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
    ...
    fn exec_split<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_batch_split<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_prepare_merge<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_commit_merge<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_rollback_merge<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_compact_log<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_compute_hash<E: KvEngines<Kv = EK>>(
        &self,
        ctx: &ApplyContext<E>,
        _: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
    ...
    fn exec_verify_hash<E: KvEngines<Kv = EK>>(
        &self,
        _: &ApplyContext<E>,
        req: &AdminRequest,
    ) -> Result<(AdminResponse, ApplyResult<EK::Snapshot>)> {
...
impl Registration {
    pub fn new<E: KvEngines>(peer: &Peer<E>) -> Registration {
        Registration {
            id: peer.peer_id(),
            term: peer.term(),
...
impl<EK: KvEngine> Msg<EK> {
    ...
    pub fn register<E: KvEngines<Kv = EK>>(peer: &Peer<E>) -> Msg<EK> {
...
impl<EK: KvEngine> Debug for Msg<EK> {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self {
...
impl<EK: KvEngine> ApplyFsm<EK> {
    fn from_peer<EE: KvEngines<Kv = EK>>(
        peer: &Peer<EE>,
    ...
    fn handle_apply<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
    ...
    fn destroy<E: KvEngines<Kv = EK>>(&mut self, ctx: &mut ApplyContext<E>) {
    ...
    fn logs_up_to_date_for_merge<E: KvEngines<Kv = EK>>(
        &mut self,
        ctx: &mut ApplyContext<E>,
    ...
    #[allow(unused_mut)]
    fn handle_snapshot<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
    ...
    fn handle_change<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
        cmd: ChangeCmd,
        region_epoch: RegionEpoch,
    ...
    fn handle_tasks<E: KvEngines<Kv = EK>>(
        &mut self,
        apply_ctx: &mut ApplyContext<E>,
        msgs: &mut Vec<Msg<E::Kv>>,
    ) {
...
impl<EK: KvEngine> Drop for ApplyFsm<EK> {
    fn drop(&mut self) {
        self.delegate.clear_all_commands_as_stale();
    }
}
...
pub struct ApplyPoller<E: KvEngines> {
    msg_buf: Vec<Msg<E::Kv>>,
    apply_ctx: ApplyContext<E>,
    messages_per_tick: usize,
    cfg_tracker: Tracker<Config>,
}

impl<E: KvEngines> PollHandler<ApplyFsm<E::Kv>, ControlFsm> for ApplyPoller<E> {
    ...
    fn handle_normal(&mut self, normal: &mut ApplyFsm<E::Kv>) -> Option<usize> {
    ...
    fn end(&mut self, fsms: &mut [Box<ApplyFsm<E::Kv>>]) {
...
pub struct Builder<E: KvEngines> {
    tag: String,
...
impl<EK: KvEngine> Deref for ApplyRouter<EK> {
...
impl<EK: KvEngine> DerefMut for ApplyRouter<EK> {
...
impl<EK: KvEngine> ApplyBatchSystem<EK> {
    pub fn schedule_all<'a, E: 'a>(&self, peers: impl Iterator<Item = &'a Peer<E>>)
    where
        E: KvEngines<Kv = EK>,
    {
