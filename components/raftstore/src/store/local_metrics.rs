...
pub struct RaftMetrics {
    ...
    pub raft_log_force_gc: RaftLogForceGcCounterVec,
...
impl RaftMetrics {
    pub fn new(waterfall_metrics: bool) -> Self {
        Self {
            ...
            raft_log_force_gc: RaftLogForceGcCounterVec::from(&RAFT_LOG_FORCE_GC_COUNTER_VEC),
