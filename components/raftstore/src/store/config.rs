...
mod tests {
    ...
    fn test_config_validate() {
        ...
        cfg.validate(split_size, false, ReadableSize(0), ReadableDuration::millis(100), false)
            .unwrap();
        assert_eq!(
        ...
        cfg.optimize_for(false);
        cfg.validate(ReadableSize(20), false, ReadableSize(0), ReadableDuration::millis(100), false)
            .unwrap();
        ...
        cfg.optimize_for(false);
        cfg.validate(ReadableSize::mb(1), false, ReadableSize(0), ReadableDuration::millis(100), false)
            .unwrap();
        ...
        cfg = Config::new();
        cfg.optimize_for(false);
        cfg.validate(split_size, true, split_size / 8, ReadableDuration::millis(100), false)
            .unwrap();
        assert_eq!(cfg.region_split_check_diff(), split_size / 16);

        cfg = Config::new();
        cfg.optimize_for(false);
        cfg.validate(split_size, true, split_size / 20, ReadableDuration::millis(100), false)
            .unwrap();
