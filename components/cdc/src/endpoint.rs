...
mod tests {
    ...
    fn test_raftstore_is_busy() {
        ...
        let downstream = Downstream::new("".to_string(), region_epoch, 0, conn_id, ChangeDataRequestKvApi::TiBd);
    ...
    fn test_register() {
        ...
        req.set_region_id(1);
        let region_epoch = req.get_region_epoch().clone();
        let downstream = Downstream::new("".to_string(), region_epoch.clone(), 1, conn_id, ChangeDataRequestKvApi::TiBd);
        ...
        let downstream = Downstream::new("".to_string(), region_epoch.clone(), 2, conn_id, ChangeDataRequestKvApi::TiBd);
        suite.run(Task::Register {
            request: req.clone(),
            downstream,
            conn_id,
        ...
        // Compatibility error.
        let downstream = Downstream::new("".to_string(), region_epoch, 3, conn_id, ChangeDataRequestKvApi::TiBd);
        suite.run(Task::Register {
            request: req,
            downstream,
            conn_id,
        ...
        let downstream = Downstream::new("".to_string(), region_epoch, 1, conn_id, ChangeDataRequestKvApi::TiBd);
        suite.run(Task::Register {
            request: req,
            downstream,
            conn_id,
    ...
    fn test_feature_gate() {
        ...
        req.set_region_id(1);
        let region_epoch = req.get_region_epoch().clone();
        let downstream = Downstream::new("".to_string(), region_epoch.clone(), 0, conn_id, ChangeDataRequestKvApi::TiBd);
    ...
    fn test_deregister_conn_then_delegate() {
        ...
        let downstream = Downstream::new("".to_string(), region_epoch_2.clone(), 0, conn_id_a, ChangeDataRequestKvApi::TiBd);
        suite.run(Task::Register {
            request: req.clone(),
            downstream,
            conn_id: conn_id_a,
        ...
        let downstream = Downstream::new("".to_string(), region_epoch_1, 0, conn_id_b, ChangeDataRequestKvApi::TiBd);
        suite.run(Task::Register {
            request: req.clone(),
            downstream,
            conn_id: conn_id_b,
