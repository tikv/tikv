...
mod tests_normal {
    ...
    fn test_no_generic_generate_fn_trait() {
        ...
        assert_eq!(expected.to_string(), r#gen.generate_fn_trait().to_string());
    }
    ...
    fn test_no_generic_generate_dummy_fn_trait_impl() {
        ...
        assert_eq!(
            expected.to_string(),
            r#gen.generate_dummy_fn_trait_impl().to_string()
        );
    }
    ...
    fn test_no_generic_generate_real_fn_trait_impl() {
        ...
        assert_eq!(
            expected.to_string(),
            r#gen.generate_real_fn_trait_impl().to_string()
        );
    }
    ...
    fn test_no_generic_generate_evaluator() {
        ...
        assert_eq!(expected.to_string(), r#gen.generate_evaluator().to_string());
    }
    ...
    fn test_no_generic_generate_constructor() {
        ...
        assert_eq!(
            expected.to_string(),
            r#gen.generate_constructor().to_string()
        );
    }
    ...
    fn test_no_generic_with_extras_generate_real_fn_trait_impl() {
        let r#gen = no_generic_fn_with_extras();
        let expected: TokenStream = quote! {
            impl<
                    'arg_,
    ...
    fn test_enum_fn_generate_real_fn_trait_impl() {
        ...
        assert_token_stream_equal(expected, r#gen.generate_real_fn_trait_impl());
    }
