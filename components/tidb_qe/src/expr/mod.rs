...
use tidb_qe_datatype::FieldTypeFlag;
...
mod tests {
    ...
    use tidb_qe_datatype::{self, Collation, FieldTypeAccessor, FieldTypeFlag, FieldTypeTp};
    use tipb::expression::{Expr, ExprType, FieldType, ScalarFuncSig};
    ...
    fn test_expression_eval() {
        ...
        for (sig, cols, exp) in cases {
            ...
            ex.mut_field_type()
                ...
                .set_flen(tidb_qe_datatype::UNSPECIFIED_LENGTH);
