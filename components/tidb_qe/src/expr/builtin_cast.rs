...
use tidb_qe_datatype::{self, FieldTypeFlag, FieldTypeTp};
...
mod tests {
    ...
    use tidb_qe_datatype::{self, FieldTypeAccessor, FieldTypeFlag, FieldTypeTp};
    ...
    fn test_cast_as_real() {
        ...
        let cases = vec![
            (
                ...
                FieldTypeTp::LongLong,
                vec![Datum::I64(1)],
                tidb_qe_datatype::UNSPECIFIED_LENGTH,
                tidb_qe_datatype::UNSPECIFIED_LENGTH,
                1f64,
            ),
            (
    ...
    fn test_cast_as_str() {
        ...
        for (sig, tp, charset, to_tp, col, flen, exp) in cases {
            ...
            ex.mut_field_type()
                .as_mut_accessor()
                .set_flen(flen)
                .set_decimal(tidb_qe_datatype::UNSPECIFIED_LENGTH);
            if to_tp.is_some() {
