...
impl MemBackend {
    pub fn new(method: EncryptionMethod, key: Vec<u8>) -> Result<MemBackend> {
...
mod tests {
    ...
    fn test_file_backend_ase_256_ctr() {
        ...
        let backend = MemBackend::new(EncryptionMethod::Aes256Ctr, key).unwrap();
