...
/// Use 128 bits for data key as default.
const DEFAULT_DATAKEY_SIZE: u8 = 32;
pub const ENCRYPTION_VENDOR_NAME_AZURE_KMS: &str = "Azure";
...
impl AzureKms {
    ...
    pub fn new(config: Config) -> Result<Self> {
        ...
        // Credentials for accessing KeyVault and Hsm should be different.
...
impl KmsProvider for AzureKms {
    ...
    async fn generate_data_key(&self) -> Result<DataKeyPair> {
        // Get random bytes as the plaintext of a new data key.
        let random_bytes = {
            let resp = self
                .hsm_client
