...
use super::utils::{TokenCache, TokenCredentialWithCache, DEFAULT_REFRESH_TIME};
...
///
/// TODO: make `ClientCertificateCredentialWithCache` directly extended from
/// `ClientCertificateCredential` if `ClientCertificateCredential` is nightly
/// released.
pub struct ClientCertificateCredentialWithCache {
...
impl ClientCertificateCredentialWithCache {
    /// Create a new ClientCertificateCredentialWithCache
    pub fn new(
        tenant_id: String,
        client_id: String,
        certificate: String,
    ...
    /// Build a new ClientCertificateCredentialWithCache according to
    /// a given certificate.
    pub fn build(
        tenant_id: String,
        client_id: String,
...
impl TokenCredentialWithCache for ClientCertificateCredentialWithCache {
...
impl TokenCredential for ClientCertificateCredentialWithCache {
    async fn get_token(&self, resource: &str) -> azure_core::Result<TokenResponse> {
        ...
        let thumbprint =
            ClientCertificateCredentialWithCache::get_thumbprint(cert).map_err(openssl_error)?;
        ...
        let header = ClientCertificateCredentialWithCache::as_jwt_part(header.as_bytes());

        let payload = format!(
            r#"{{"aud":"{}","exp":{},"iss": "{}", "jti": "{}", "nbf": {}, "sub": "{}"}}"#,
            url, expiry_time, self.client_id, uuid, current_time, self.client_id
        );
        let payload = ClientCertificateCredentialWithCache::as_jwt_part(payload.as_bytes());

        let jwt = format!("{}.{}", header, payload);
        let signature =
            ClientCertificateCredentialWithCache::sign(&jwt, pkey).map_err(openssl_error)?;
        let sig = ClientCertificateCredentialWithCache::as_jwt_part(&signature);
