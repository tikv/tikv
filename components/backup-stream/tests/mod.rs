...
impl SuiteBuilder {
    ...
    pub fn build(self) -> Suite {
        ...
        //       We must wait until the endpoints get ready to watching the metastore,
        // or some modifies may be lost.       Either make Endpoint::with_client
        // wait until watch did start or make slash_etc support multi-version,
...
mod test {
    ...
    #[test]
    /// This case tests whehter the checkpoint ts (next backup ts) can be
    ...
    fn inflight_messages() {
        ...
        .unwrap();
        // The checkpoint should be advanced as expection when the inflight message has
        // been consumed.
