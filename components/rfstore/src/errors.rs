...
impl ErrorCodeExt for Error {
    fn error_code(&self) -> ErrorCode {
        match self {
            ...
            Error::RFEngineError(e) => match e {
                rfengine::Error::Io(_) => error_code::raftstore::IO,
                rfengine::Error::EOF => error_code::raftstore::UNKNOWN,
            ...
            Error::KVEngineError(e) => match e {
                ...
                kvengine::Error::AlreadySplitting => error_code::raftstore::UNKNOWN,
