...
mod tests {
    ...
    fn test_it_works_integration() {
        ...
        // col_0
        assert_eq!(
            r.physical_columns[3].decoded().as_bytes_vec(),
            &[None, None]
        );
        // col_1
        assert_eq!(
            r.physical_columns[4].decoded().as_real_vec(),
        ...
        // AVG_COUNT
        assert_eq!(r.physical_columns[1].decoded().as_int_vec(), &[Some(5)]);
        // AVG_SUM
        assert_eq!(
            r.physical_columns[2].decoded().as_real_vec(),
            &[Real::new(-20.0).ok()]
    ...
    fn test_no_fn() {
        ...
        // col_1
        assert_eq!(
            r.physical_columns[1].decoded().as_real_vec(),
