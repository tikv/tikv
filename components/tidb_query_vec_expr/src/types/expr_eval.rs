...
mod tests {
    ...
    fn test_eval_single_constant_node() {
        ...
        assert_eq!(val.scalar_value().unwrap().as_real(), Real::new(1.5).ok().as_ref());
    ...
    fn test_rpn_fn_data() {
        ...
        fn fn_a<T: Evaluable + EvaluableRet>(metadata: &i64, v: Option<&Int>) -> Result<Option<Int>> {
        ...
        fn fn_b<T: Evaluable + EvaluableRet>(metadata: &String, v: &[Option<&T>]) -> Result<Option<T>> {
