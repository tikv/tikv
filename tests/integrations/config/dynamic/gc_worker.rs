...
use tikv::server::gc_worker::{AutoGcConfig, GcTask, GcWorker};
use tikv::server::gc_worker::{MockRegionInfoProvider, MockSafePointProvider};
...
#[cfg(test)]
fn setup_cfg_controller(cfg: TiKvConfig) -> (GcWorker, ConfigController) {
