...
// Copied from https://github.com/pingcap/pd/blob/15904a72224b678a089973ca30934e38cfc727ec/server/grpc_service.go#L91
const BOOTSTRAP_ERROR: &'static str = "cluster is already bootstrapped";

impl Mocker for Bootstrap {
    fn Bootstrap(&self, _: &BootstrapRequest) -> Option<Result<BootstrapResponse>> {
        let mut err = Error::new();
        err.set_message(BOOTSTRAP_ERROR.to_owned());
