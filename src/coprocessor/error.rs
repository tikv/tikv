...
impl From<Error> for tidb_query_datatype::error::StorageError {
    fn from(err: Error) -> Self {
        failure::Error::from(err).into()
    }
}

impl From<tidb_query_datatype::error::StorageError> for Error {
    fn from(err: tidb_query_datatype::error::StorageError) -> Self {
...
impl From<tidb_query_datatype::error::EvaluateError> for Error {
    fn from(err: tidb_query_datatype::error::EvaluateError) -> Self {
        Error::Other(err.to_string())
    }
}

impl From<tidb_query_datatype::Error> for Error {
    fn from(err: tidb_query_datatype::Error) -> Self {
