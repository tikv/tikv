...
impl From<ScalarFuncSig> for CmpOp {
    fn from(sig: ScalarFuncSig) -> Self {
        match sig {
            ScalarFuncSig::LTInt |
            ...
            ScalarFuncSig::NullEQJson => CmpOp::NullEQ,
