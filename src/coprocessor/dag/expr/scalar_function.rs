...
impl ScalarFunc {
    pub fn check_args(sig: ScalarFuncSig, args: usize) -> Result<()> {
        let (min_args, max_args) = match sig {
            ...
            | ScalarFuncSig::IntLogicalAnd
            | ScalarFuncSig::RealLogicalAnd
            | ScalarFuncSig::IntLogicalOr
            | ScalarFuncSig::RealLogicalOr
...
dispatch_call! {
    INT_CALLS {
        ...
        IntLogicalAnd => int_logical_and,
        RealLogicalAnd => real_logical_and,
