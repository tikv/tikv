...
fn map_pb_sig_to_rpn_func(value: ScalarFuncSig, children: &[Expr]) -> Result<RpnFnMeta> {
    Ok(match value {
        ...
        ScalarFuncSig::IntLogicalAnd => int_logical_and_fn_meta(),
        ScalarFuncSig::RealLogicalAnd => real_logical_and_fn_meta(),
        ScalarFuncSig::IntLogicalOr => int_logical_or_fn_meta(),
        ScalarFuncSig::RealLogicalOr => real_logical_or_fn_meta(),
