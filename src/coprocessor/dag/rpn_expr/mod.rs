...
fn map_pb_sig_to_rpn_func(value: ScalarFuncSig, children: &[Expr]) -> Result<RpnFn> {
    Ok(match value {
        ...
        ScalarFuncSig::IfNullInt => if_null_fn::<Int>(),
        ScalarFuncSig::IfNullReal => if_null_fn::<Real>(),
        ScalarFuncSig::IfNullString => if_null_fn::<Bytes>(),
        ScalarFuncSig::IfNullDecimal => if_null_fn::<Decimal>(),
        ScalarFuncSig::IfNullTime => if_null_fn::<DateTime>(),
        ScalarFuncSig::IfNullDuration => if_null_fn::<Duration>(),
        ScalarFuncSig::IfNullJson => if_null_fn::<Json>(),
