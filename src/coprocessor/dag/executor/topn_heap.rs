...
mod tests {
    ...
    fn test_topn_heap() {
        ...
        for (handle, data, name, count) in test_data {
            ...
            topn_heap
                .try_add_row(
                    Row::origin(i64::from(handle), row_data, Arc::default()),
                    cur_key,
    ...
    fn test_topn_heap_with_cmp_error() {
        ...
        topn_heap
            .try_add_row(
                Row::origin(0 as i64, row_data, Arc::default()),
                std_key,
                Arc::clone(&order_cols),
            )
            .unwrap();
        ...
        topn_heap
            .try_add_row(
                Row::origin(0 as i64, row_data2, Arc::default()),
                std_key2,
                Arc::clone(&order_cols),
            )
            .unwrap();
    ...
    fn test_topn_with_empty_limit() {
        ...
        topn_heap
            .try_add_row(
                Row::origin(i64::from(1), row_data, Arc::default()),
                cur_key,
                Arc::new(Vec::default()),
            )
            .unwrap();
