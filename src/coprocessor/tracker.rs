...
impl Tracker {
    ...
    fn exec_details(&self, measure: Duration) -> (kvrpcpb::ExecDetails, kvrpcpb::ExecDetailsV2) {
        ...
        td.set_kv_read_wall_time_ms(self.read_used_time);
        ...
        detail_v2.set_read_bytes(self.total_storage_stats.data.flow_stats.read_bytes as u64);
