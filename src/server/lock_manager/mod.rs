...
const DETECTED_SLOTS_NUM: usize = 32;

#[inline]
fn slot_idx(txn_ts: u64) -> usize {
...
impl LockManager {
    ...
    fn add_to_detected(&self, txn_ts: u64) {
        let mut detected = self.detected[slot_idx(txn_ts)].lock();
...
mod tests {
    ...
    fn start_lock_manager() -> LockManager {
        ...
        // Make sure the deadlock detector is leader.
