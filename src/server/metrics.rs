...
impl From<&'static str> for GrpcTypeKind {
    fn from(value: &'static str) -> Self {
        match value {
            "invalid" => GrpcTypeKind::invalid,
            "kv_get" => GrpcTypeKind::kv_get,
            "kv_scan" => GrpcTypeKind::kv_scan,
            "kv_prewrite" => GrpcTypeKind::kv_prewrite,
            "kv_pessimistic_lock" => GrpcTypeKind::kv_pessimistic_lock,
            "kv_pessimistic_rollback" => GrpcTypeKind::kv_pessimistic_rollback,
            "kv_commit" => GrpcTypeKind::kv_commit,
            "kv_cleanup" => GrpcTypeKind::kv_cleanup,
            "kv_batch_get" => GrpcTypeKind::kv_batch_get,
            "kv_batch_get_command" => GrpcTypeKind::kv_batch_get_command,
            "kv_batch_rollback" => GrpcTypeKind::kv_batch_rollback,
            "kv_txn_heart_beat" => GrpcTypeKind::kv_txn_heart_beat,
            "kv_check_txn_status" => GrpcTypeKind::kv_check_txn_status,
            "kv_check_secondary_locks" => GrpcTypeKind::kv_check_secondary_locks,
            "kv_scan_lock" => GrpcTypeKind::kv_scan_lock,
            "kv_resolve_lock" => GrpcTypeKind::kv_resolve_lock,
            "kv_gc" => GrpcTypeKind::kv_gc,
            "kv_delete_range" => GrpcTypeKind::kv_delete_range,
            "kv_prepare_flashback_to_version" => GrpcTypeKind::kv_prepare_flashback_to_version,
            "kv_flashback_to_version" => GrpcTypeKind::kv_flashback_to_version,
            "raw_get" => GrpcTypeKind::raw_get,
            "raw_batch_get" => GrpcTypeKind::raw_batch_get,
            "raw_batch_get_command" => GrpcTypeKind::raw_batch_get_command,
            "raw_scan" => GrpcTypeKind::raw_scan,
            "raw_batch_scan" => GrpcTypeKind::raw_batch_scan,
            "raw_put" => GrpcTypeKind::raw_put,
            "raw_batch_put" => GrpcTypeKind::raw_batch_put,
            "raw_delete" => GrpcTypeKind::raw_delete,
            "raw_delete_range" => GrpcTypeKind::raw_delete_range,
            "raw_batch_delete" => GrpcTypeKind::raw_batch_delete,
            "raw_get_key_ttl" => GrpcTypeKind::raw_get_key_ttl,
            "raw_compare_and_swap" => GrpcTypeKind::raw_compare_and_swap,
            "raw_checksum" => GrpcTypeKind::raw_checksum,
            "unsafe_destroy_range" => GrpcTypeKind::unsafe_destroy_range,
            "register_lock_observer" => GrpcTypeKind::register_lock_observer,
            "check_lock_observer" => GrpcTypeKind::check_lock_observer,
            "remove_lock_observer" => GrpcTypeKind::remove_lock_observer,
            "coprocessor" => GrpcTypeKind::coprocessor,
            "coprocessor_stream" => GrpcTypeKind::coprocessor_stream,
            "raw_coprocessor" => GrpcTypeKind::raw_coprocessor,
            "mvcc_get_by_key" => GrpcTypeKind::mvcc_get_by_key,
            "mvcc_get_by_start_ts" => GrpcTypeKind::mvcc_get_by_start_ts,
            "split_region" => GrpcTypeKind::split_region,
            "read_index" => GrpcTypeKind::read_index,
            "check_leader" => GrpcTypeKind::check_leader,
            "batch_commands" => GrpcTypeKind::batch_commands,
            "kv_flush" => GrpcTypeKind::kv_flush,
            "kv_buffer_batch_get" => GrpcTypeKind::kv_buffer_batch_get,
            "get_health_feedback" => GrpcTypeKind::get_health_feedback,
            _ => GrpcTypeKind::invalid,
        }
    }
}
