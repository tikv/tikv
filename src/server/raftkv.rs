...
fn on_write_result(mut write_resp: Box<WriteResponse>, req_cnt: usize) -> (CbContext, Result<CmdRes>) {
...
fn on_read_result(mut read_resp: Box<ReadResponse>, req_cnt: usize) -> (CbContext, Result<CmdRes>) {
