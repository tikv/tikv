...
const DEFAULT_GRPC_GZIP_COMPRESSION_LEVEL: usize = 6;
const DEFAULT_GRPC_COMPRESSION_LOWER_BOUND: usize = 0;
...
impl Default for Config {
    fn default() -> Config {
        ...
        Config {
            ...
            grpc_gzip_compression_level: 6,
            grpc_compression_lower_bound: 0,
