...
#[derive(Clone)]
pub struct Service<T: RaftStoreRouter<K, R> + 'static, E: Engine, L: LockMgr, K: KvEngine, R: KvEngine> {
...
impl<T: RaftStoreRouter<K, R> + 'static, E: Engine, L: LockMgr, K: KvEngine, R: KvEngine> Service<T, E, L, K, R> {
...
impl<T: RaftStoreRouter<K, R> + 'static, E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static> Tikv for Service<T, E, L, K, R> {
...
fn handle_batch_commands_request<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
    cop: &Endpoint<E>,
    peer: &str,
    id: u64,
...
fn future_get<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
    mut req: GetRequest,
...
fn future_scan<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
    mut req: ScanRequest,
...
fn future_prewrite<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_acquire_pessimistic_lock<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_pessimistic_rollback<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_commit<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_cleanup<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_batch_get<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_batch_rollback<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_txn_heart_beat<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_scan_lock<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_resolve_lock<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_gc<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
    mut req: GcRequest,
...
fn future_delete_range<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_get<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_batch_get<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_put<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_batch_put<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_delete<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_batch_delete<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_scan<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_batch_scan<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
...
fn future_raw_delete_range<E: Engine, L: LockMgr, K: KvEngine + 'static, R: KvEngine + 'static>(
    storage: &Storage<E, L, K, R>,
