...
#[derive(Clone)]
pub struct Service<T: RaftStoreRouter<EE> + 'static, E: Engine, EE: Engines, L: LockMgr> {
    // For handling KV requests.
    storage: Storage<E, EE, L>,
...
impl<T: RaftStoreRouter<EE> + 'static, E: Engine, EE: Engines, L: LockMgr> Service<T, E, EE, L> {
...
impl<T: RaftStoreRouter<EE> + 'static, E: Engine, EE: Engines, L: LockMgr> Tikv for Service<T, E, EE, L> {
    ...
    fn split_region(
        ...
        let req = CasualMessage::<EE>::SplitRegion {
...
fn handle_batch_commands_request<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
    cop: &Endpoint<E>,
    peer: &str,
    id: u64,
...
fn future_get<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
    mut req: GetRequest,
...
fn future_scan<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
    mut req: ScanRequest,
...
fn future_prewrite<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_acquire_pessimistic_lock<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_pessimistic_rollback<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_commit<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_cleanup<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_batch_get<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_batch_rollback<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_scan_lock<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_resolve_lock<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_gc<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
    mut req: GcRequest,
...
fn future_delete_range<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_get<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_batch_get<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_put<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_batch_put<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_delete<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_batch_delete<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_scan<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_batch_scan<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
...
fn future_raw_delete_range<E: Engine, EE: Engines, L: LockMgr>(
    storage: &Storage<E, EE, L>,
