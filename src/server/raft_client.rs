    ...
    E: KvEngine,
{
    ...
    fn connect(&self, addr: &str) -> Channel {
        ...
        let cb = ChannelBuilder::new(self.builder.env.clone())
            ...
            .max_reconnect_backoff(self.builder.cfg.raft_client_max_backoff.0)
            .initial_reconnect_backoff(self.builder.cfg.raft_client_initial_reconnect_backoff.0)
    ...
    E: KvEngine,
{
    ...
    let backoff_duration = back_end.builder.cfg.raft_client_max_backoff.0;
