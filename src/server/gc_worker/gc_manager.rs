...
impl KeyspaceLevelGCWatchService {
    ...
    pub fn new(
        ...
        KeyspaceLevelGCWatchService {
            ...
            pd_client,
            ks_safepoint_v2:keyspace_level_gc,
        }
    }
                        ...
                        events.iter().for_each(|event| match event.get_type() {
                            EventEventType::Put => {
                                ...
                                match serde_json::from_slice::<KeyspaceLevelGC>(
                                    ...
                                    Ok(keyspace_level_gc) => {
                                        self.ks_safepoint_v2.insert(keyspace_level_gc.keyspace_id, keyspace_level_gc.safe_point);
                            ...
                            EventEventType::Delete => {
                                ...
                                match serde_json::from_slice::<KeyspaceLevelGC>(
                                    ...
                                    Ok(keyspace_level_gc) => {
                                        self.ks_safepoint_v2.remove(&keyspace_level_gc.keyspace_id);
                ...
                Ok(mut resp) => {
                    ...
                    kvs.iter().for_each(|g| {
                        match serde_json::from_slice::<KeyspaceLevelGC>(
                            ...
                            Ok(keyspace_level_gc) => {self.ks_safepoint_v2.insert(keyspace_level_gc.keyspace_id, keyspace_level_gc.safe_point);info!("[test-yjy]EventEventType::Put02-01 {},{}",keyspace_level_gc.keyspace_id,keyspace_level_gc.safe_point);},
