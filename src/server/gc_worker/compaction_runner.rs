...
/// score near the scale of the existing row-based score makes byte-based
/// candidates comparable with the legacy count-based ones.
...
/// Calculates compaction score based on tombstones and estimated reclaimable
/// bytes.
