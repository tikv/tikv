...
impl<E: Engine> GcWorker<E> {
    pub fn new(
        ...
        let worker_builder = WorkerBuilder::new(GC_WORKER_THREAD_PREFIX)
            .pending_capacity(GC_MAX_PENDING_TASKS)
            .thread_count(cfg.num_threads);
        let worker = worker_builder.create().lazy_build(GC_WORKER_THREAD_PREFIX);
    ...
    pub fn start(
        ...
        let runner = GcRunner::new(
            ...
            self.config_manager
                .0
                .clone()
                .tracker(GC_WORKER_THREAD_PREFIX.to_owned()),
