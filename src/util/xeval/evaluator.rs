...
mod test {
    ...
    test_eval!(test_eval_datum_col,
               vec![(datum_expr(Datum::F64(1.1)), Datum::F64(1.1)),
    ...
    test_eval!(test_eval_cmp,
               vec![(bin_expr(Duration::parse(b"11:00:00", 0).unwrap().into(),
                    ...
                    (bin_expr(Duration::parse(b"11:00:00.233", 3).unwrap().into(),
                              ...
                              ExprType::EQ),
                     Datum::I64(1)),
                    (bin_expr(Datum::Dec(Decimal::from_f64(2.0).unwrap()),
                              Datum::Dec(2u64.into()),
                              ExprType::EQ),
                     Datum::I64(1)),
    ...
    test_eval!(test_eval_logic,
               vec![(bin_expr(Datum::I64(0), Datum::I64(1), ExprType::And), Datum::I64(0)),
    ...
    test_eval!(test_eval_plus,
               vec![(bin_expr(Datum::I64(1), Datum::I64(1), ExprType::Plus), Datum::I64(2)),
                    ...
                    (bin_expr(Datum::I64(i64::min_value()),
                    ...
                    (bin_expr(Datum::Dec("3.3".parse().unwrap()),
                              Datum::I64(-1),
                              ExprType::Plus),
                     Datum::Dec("2.3".parse().unwrap())),
                    (bin_expr(Datum::F64(2.0),
    ...
    test_eval!(test_eval_div,
               vec![(bin_expr(Datum::I64(1), Datum::I64(1), ExprType::Div), Datum::Dec(1.into())),
    ...
    test_eval!(test_eval_minus,
               vec![(bin_expr(Datum::I64(1), Datum::I64(1), ExprType::Minus), Datum::I64(0)),
    ...
    test_eval!(test_eval_mul,
               vec![(bin_expr(Datum::I64(1), Datum::I64(1), ExprType::Mul), Datum::I64(1)),
    ...
    test_eval!(test_eval_int_div,
               vec![(bin_expr(Datum::I64(1), Datum::I64(1), ExprType::IntDiv), Datum::I64(1)),
    ...
    test_eval!(test_eval_rem,
               vec![(bin_expr(Datum::I64(3), Datum::I64(1), ExprType::Mod), Datum::I64(0)),
                    ...
                    (bin_expr(Datum::I64(i64::min_value()),
                              ...
                              ExprType::Mod),
                     Datum::I64(-1)),
                    (bin_expr(Datum::U64(i64::max_value() as u64),
    ...
    test_eval!(test_eval_case_when,
               vec![(case_when(vec![Datum::I64(0),
                    ...
                    (case_when(vec![Datum::I64(0),
                                    ...
                                    b"case3".as_ref().into()]),
                     Datum::Null),
                    (build_expr_r(vec![case_when(vec![Datum::I64(0),
                                                      Datum::I64(0),
                                                      Datum::I64(1),
                                                      Datum::I64(1)]),
    ...
    test_eval!(test_eval_if,
               vec![(build_expr(vec![true.into(),
                                     b"expr1".as_ref().into(),
                                     b"expr2".as_ref().into()],
                                ExprType::If),
                     b"expr1".as_ref().into()),
                    (build_expr(vec![false.into(),
                                     b"expr1".as_ref().into(),
                                     b"expr2".as_ref().into()],
                                ExprType::If),
                     b"expr2".as_ref().into()),
                    (build_expr(vec![Datum::Null,
                                     b"expr1".as_ref().into(),
                                     b"expr2".as_ref().into()],
                                ExprType::If),
                     b"expr2".as_ref().into()),
                    ...
                    (build_expr(vec![false.into(), b"expr1".as_ref().into(), Datum::Null],
                                ExprType::If),
                     Datum::Null),
                    (build_expr_r(vec![build_expr(vec![true.into(), Datum::Null, true.into()],
                                                  ExprType::If),
                                       build_expr(vec![true.into(),
                                                       b"expr1".as_ref().into(),
                                                       b"expr2".as_ref().into()],
                                                  ExprType::If),
                                       build_expr(vec![false.into(),
    ...
    test_eval!(test_eval_coalesce,
               vec![(coalesce(vec![Datum::Null, Datum::Null, Datum::Null]), Datum::Null),
                    (coalesce(vec![Datum::Null, b"not-null".as_ref().into(), Datum::Null]),
                     b"not-null".as_ref().into()),
                    (coalesce(vec![Datum::Null,
                                   b"not-null".as_ref().into(),
    ...
    test_eval!(test_eval_if_null,
               vec![(build_expr(vec![Datum::Null, b"right".as_ref().into()],
                                ExprType::IfNull),
                     b"right".as_ref().into()),
                    (build_expr(vec![b"left".as_ref().into(), b"right".as_ref().into()],
                                ExprType::IfNull),
                     b"left".as_ref().into()),
                    (build_expr(vec![b"left".as_ref().into(), Datum::Null], ExprType::IfNull),
                     b"left".as_ref().into()),
                    (build_expr(vec![Datum::Null, Datum::Null], ExprType::IfNull), Datum::Null)]);

    test_eval!(test_eval_is_null,
               vec![(build_expr(vec![b"abc".as_ref().into()], ExprType::IsNull), false.into()),
    ...
    test_eval!(test_eval_null_if,
               vec![(build_expr(vec![b"abc".as_ref().into(), b"abc".as_ref().into()],
                                ExprType::NullIf),
                     Datum::Null),
                    (build_expr(vec![Datum::Null, Datum::Null], ExprType::NullIf), Datum::Null),
    ...
    #[test]
    fn test_where_in() {
        let cases = vec![(in_expr(Datum::I64(1), vec![Datum::I64(1), Datum::I64(2)]),
                          Datum::I64(1)),
