...
mod test {
    ...
    fn test_datum_cmp() {
        let tests =
            vec![(Datum::F64(-1.0), Datum::Min, Ordering::Greater),
    ...
    fn test_datum_to_bool() {
        let tests =
            vec![(Datum::I64(0), Some(false)),
                 ...
                 (Time::parse_utc_datetime("2011-11-10 11:11:11.999999", 6).unwrap().into(),
                  Some(true)),
    ...
    fn test_coerce_datum() {
        let cases =
            vec![(Datum::I64(1), Datum::I64(1), Datum::I64(1), Datum::I64(1)),
