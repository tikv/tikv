...
mod test {
    ...
    fn test_parse_datetime() {
        let ok_tables = vec![("2012-12-31 11:30:45", UN_SPECIFIED_FSP, "2012-12-31 11:30:45"),
        ...
        let fail_tbl = vec!["1000-00-00 00:00:00",
                            "1000-01-01 00:00:70",
                            "1000-13-00 00:00:00",
    ...
    #[test]
    fn test_codec() {
        let cases = vec![("2010-10-10 10:11:11", 0),
    ...
    #[test]
    fn test_to_dec() {
        let cases = vec![("12-12-31 11:30:45", 0, "20121231113045", "20121231"),
    ...
    fn test_compare() {
        let cases =
            vec![("2011-10-10 11:11:11", "2011-10-10 11:11:11", Ordering::Equal),
    ...
    fn test_parse_datetime_format() {
        let cases = vec![("2011-11-11 10:10:10.123456",
