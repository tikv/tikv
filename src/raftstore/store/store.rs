...
impl<T: Transport, C: PdClient> Store<T, C> {
    pub fn new(event_loop: &mut EventLoop<Self>,
        ...
        Ok(Store {
            ...
            split_check_worker: Worker::new("split check worker".to_owned(), 1),
            snap_worker: Worker::new("snapshot worker".to_owned(), 1),
            compact_worker: Worker::new("compact worker".to_owned(), 1),
            pd_worker: Worker::new("pd worker".to_owned(), 1),
