...
impl<T: Transport, C: PdClient> Store<T, C> {
    ...
    pub fn new(
        ...
        let mut s = Store {
            ...
            split_check_worker: Worker::new("split-check-wkr"),
            region_worker: Worker::new("snapshot-wkr"),
            raftlog_gc_worker: Worker::new("raft-gc-wkr"),
            compact_worker: Worker::new("compact-wkr"),
            pd_worker,
            consistency_check_worker: Worker::new("consistency-wkr"),
            cleanup_sst_worker: Worker::new("cleanup-sst-wkr"),
            apply_worker: Worker::new("apply-wkr"),
