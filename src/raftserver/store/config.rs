...
pub const DEFAULT_TICK_INTERVAL_SPLIT_REGION_CHECK: u64 = 10000;
pub const DEFAULT_TICK_INTERVAL_REPLICA_CHECK: u64 = 5 * 60 * 1000;
...
pub struct Config {
    ...
    pub tick_interval_split_region_check: u64,
    /// Interval (ms) to check region whether need to be add or remove replica.
    pub tick_interval_replica_check: u64,
...
impl Default for Config {
    fn default() -> Config {
        Config {
            ...
            tick_interval_split_region_check: DEFAULT_TICK_INTERVAL_SPLIT_REGION_CHECK,
            tick_interval_replica_check: DEFAULT_TICK_INTERVAL_REPLICA_CHECK,
