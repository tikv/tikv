...
use crate::storage::mvcc::{
    txn::make_rollback, LockType, MvccTxn, ReleasedLock, Result as MvccResult, SecondaryLockStatus,
    TimeStamp, TxnCommitRecord,
};
...
impl CheckSecondaryLocks {
    ...
    pub fn check_secondary_lock<S: Snapshot>(
        &mut self,
        txn: &mut MvccTxn<S>,
        key: &Key,
    ) -> MvccResult<(SecondaryLockStatus, Option<ReleasedLock>)> {
