...
mod tests {
    ...
    fn test_seek_write() {
        ...
        assert_eq!(write, Write::commit(WriteType::Put, 23, Some(v.to_vec())));
        ...
        assert_eq!(write, Write::commit(WriteType::Put, 1, Some(v2.to_vec())));
