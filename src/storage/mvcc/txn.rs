...
impl<S: Snapshot, P: PdClient + 'static> MvccTxn<S, P> {
    ...
    pub fn unlock_key(&mut self, key: Key, pessimistic: bool) -> Option<ReleasedLock> {
...
pub fn make_txn_error(s: Option<String>, key: &Key, start_ts: TimeStamp) -> ErrorInner {
    if let Some(s) = s {
