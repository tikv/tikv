...
impl<E: Engine, L: LockManager> Storage<E, L> {
    ...
    pub fn delete_range(
        ...
        self.engine.async_write(
            &ctx,
            WriteData::from_modifies_with_allowed(modifies),
    ...
    pub fn raw_put(
        ...
        self.engine.async_write(
            &ctx,
            WriteData::from_modifies_with_allowed(vec![m]),
            Box::new(|(_, res): (_, kv::Result<_>)| callback(res.map_err(Error::from))),
        )?;
    ...
    pub fn raw_delete(
        ...
        self.engine.async_write(
            &ctx,
            WriteData::from_modifies_with_allowed(vec![Modify::Delete(
                Self::rawkv_cf(&cf)?,
                Key::from_encoded(key),
            )]),
            Box::new(|(_, res): (_, kv::Result<_>)| callback(res.map_err(Error::from))),
    ...
    pub fn raw_delete_range(
        ...
        self.engine.async_write(
            &ctx,
            WriteData::from_modifies_with_allowed(vec![Modify::DeleteRange(
